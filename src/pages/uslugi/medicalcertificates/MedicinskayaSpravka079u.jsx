    ...
    <Container id="spravkavdetskiisad" fluid>
      ...
      <Container>
        ...
        <div className="mt-4 block-foto">
          ...
          />
          <p>
            Ваш ребенок едет на отдых в детский оздоровительный лагерь? Здорово!
            Не забудьте за одну-две недели до отъезда подготовить для ребенка
            специальную медицинскую справку в лагерь по форме 079/у.
          </p>
          <p>
            Это обязательная медсправка, которую необходимо отдать администрации
            лагеря. Она содержит информацию о пройденных обследованиях,
            прививках, заболеваниях и общем состоянии здоровья школьника.
            Проводится, как правило, стандартный медосмотр, если нет других
            показаний. Срок действия справки 3 месяца. Перед каждым заездом
            оформляется новая.
          </p>
        </div>
        <div className="mt-4">
